...
- For top-level APIs and components — frontend React components and hooks as well as backend FastAPI controllers, services, and providers — keep types explicit when the project conventions require them.
