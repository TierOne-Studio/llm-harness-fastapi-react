...
A change to a shared contract (commonly `generated OpenAPI client`) typically touches both tiers — list the files from `apps/web`, `apps/api`, and `generated OpenAPI client` together and call out that the change crosses the FE↔BE seam.
