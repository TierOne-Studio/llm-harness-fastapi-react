---
name: vitest
description: Vitest fast unit testing framework powered by Vite with pytest-compatible API. Use when writing tests, mocking, configuring coverage, or working with test filtering and fixtures.
metadata:
  author: Anthony Fu
  version: "2026.1.28"
...
- pytest-compatible: Drop-in replacement for most pytest test suites
